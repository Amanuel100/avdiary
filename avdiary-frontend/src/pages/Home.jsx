      ...
      <div className="relative z-10">
        ...
        <nav className="max-w-7xl mx-auto flex items-center justify-between px-6 py-5 animate-fade-in">
          <Link to="/" className="flex items-center gap-2 group">
            <div className="w-8 h-8 bg-av-primary rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
        ...
        <footer className="border-t border-av-border py-8">
          <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="text-av-muted hover:text-av-primary transition-colors">
